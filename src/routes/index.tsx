        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <div className="glass-panel grid gap-8 rounded-3xl p-6 md:grid-cols-2 md:p-10">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="mt-4 text-3xl">{BUNDLE.title}</h2>
              <p className="mt-3 text-sm text-muted-foreground">
                Both seasons of the Shadowrealm story as PDF editions, bundled at a lower price
              ...
              >
                {bundleInCart ? "Bundle in cart" : "Get the bundle"}
              </Button>
            </div>
          </div>
        </div>
